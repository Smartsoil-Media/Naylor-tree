    ...
    <article className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
      ...
      <Section title="The cove at the foot of Bray Head">
        ...
        <p>
          ...
          from England, though no one now knows why or when they crossed to Ireland. By the 1800s
      ...
      <Section title="The earliest Naylors we can name (1801–1849)">
        <p>
          ...
          dates. We don't know what became of most of them.
        </p>
        <p>
          ...
          Samuel Little Stevenson and Mary N. Hill.
        </p>
        <p>
          ...
          others in between whose records were lost.
        </p>
        <p>
      ...
      <Section title="Bartholomew and Mary Anne (1878)">
        ...
        <p>
          ...
          was still standing on the forest road in the 1950s.
        </p>
        <p>
          And in the late 1890s, he took a lease from the Town Commissioners on the small rocky
          cove at the foot of Bray Head. He built bathing huts there and a small pier to make
          swimming and diving easier. People began calling it Naylor's Cove. The name stuck. In
          ...
          association with that piece of coastline was already well established.
        </p>
        <p className="!mt-7">
        ...
        <ul className="!mt-3 list-none space-y-1 border-l-2 border-sepia-300 pl-5 text-[17px]">
          ...
          <li>Annabella — 4 March 1887</li>
          <li>William John — 10 April 1889</li>
        ...
        <p className="!mt-7">
          ...
          tight community by the harbour.
        </p>
      </Section>

      <Section title="A family scattered (1880s–1920s)">
        <p>The Naylor children of Newcourt Cottage took very different paths.</p>
        <p>
        ...
        <p>
          ...
          them, Samuel and Frederick, died young.
        </p>
        <p>
          ...
          Hove, on the Sussex coast, married to an engineer in the electricity industry.
        </p>
        <p>
      ...
      <Section title="The Somme, 1916">
        ...
        <p>
          ...
          Hughes — Lydia's husband — to their daughter Marian. Where it is now, no one knows.
        </p>
      </Section>
      ...
      <Section title="Lydia and William (1915–1924)">
        ...
        <p>
          ...
          mother-in-law in her late fifties or early sixties."
        </p>
        <p>
        ...
        <p>
          ...
          back across the Irish Sea, and Marion Lydia Hughes was born in Bray, Co. Wicklow.
        </p>
      ...
      <Section title="The crab, the curtain, and the candle">
        <p>
          ...
          Bartholomew, in his sixties. He remembered the crossings from Fishguard to Rosslare,
        ...
        <p>
          ...
          night, and <em>"despite a search and many tears, it was not to be found."</em>
        </p>
        <p>
          ...
          Aunt Lillie then went out to a singing engagement she had been on her way to.
        </p>
        <p>
        ...
        <p>
          ...
          downstairs room, which had become her bedroom.
        </p>
        <p>
          This went on for some time, until one morning on his way home from school, the
          milkman's son said to him: <em>"the curtains in your house are all drawn over."</em>
        </p>
      ...
      <Section title="The next generation">
        <p>
          ...
          time, she married Donald Newman, and they had two children: Anne and Peter.
        </p>
        <p>
          Anne married Mark Mackay, and they had two children of their own: Gun and David.
        </p>
        <p>
          ...
          Hugheses of East Dulwich, became the Newmans, became the Mackays — but the cove at the
          foot of Bray Head still bears the family name.
        </p>
      </Section>
      ...
      <Section title="The wider Naylor clan">
        ...
        <p>
          ...
          coat, and was said to be as hardy as a snipe).
        </p>
        <p>
        ...
        <p>
          ...
          Club, his "great booming voice" said to carry across the water on regatta days.
        </p>
        <p>
          And there was <strong>Rose Naylor</strong>, described in one Bray pictorial book as
          "the last of the Naylors."
        </p>
        <p>
      ...
      <Section title="Sources">
        <p>This story is drawn from:</p>
        <ul className="!mt-3 list-disc list-outside pl-5 space-y-2 text-[17px]">
          <li>
            A 1999 letter from Claire Crowther of the Bray Cualann Historical Society to Mrs. Sue
            Tinney, reproducing baptism and marriage records from St. Paul's Church, Bray and
            Christ Church, Bray
          </li>
          <li>The Bray Churches database of births, baptisms, and confirmations</li>
          <li>The 1901 Census of Ireland (Dock Terrace, Bray)</li>
          <li>The Bray War Memorial register, First World War Special Edition</li>
          <li>
            <em>A Pictorial History of Bray, Co. Wicklow, Volume One: The Seafront and
            Environs</em>, by Henry Cairns and Owen Gallagher
          </li>
          <li><em>Pictorial Memories of Bray</em></li>
          <li>The <em>Bray People</em> newspaper, 24 and 31 July 1987</li>
          <li>
            A typewritten memoir by Bartholomew Edward Naylor Hughes (1917–1977), written for his
